			...
			<div>
				<div className="alloptions">
					<div className="option">
						...
						<div>
							RiseRwanda provides you with the option to choose
							which way you would like to help out.
						</div>
						<div className="donaterow">
							<img src={DonateOptionEducation} />
							...
							<img src={DonateOptionMicrofinance} />
							<div className="donateitem">
								<a
									className="nolink"
						...
						<div className="giftrow">
							<div className="giftrowitem">
								<div className="giftimage tint1">
									<img src={GiftOptionsMedical} />
									<p className="gifttext">Medical</p>
								</div>
							</div>
							<div className="giftrowitem">
								<div className="giftimage tint1">
									<img src={GiftOptionsUniforms} />
									<p className="gifttext">Uniforms</p>
								</div>
							</div>
							<div className="giftrowitem">
								<div className="giftimage tint1">
									<img src={GiftOptionsBook} />
									<p className="gifttext">Books</p>
								</div>
							</div>
							<div className="giftrowitem">
								<div className="giftimage tint1">
									<img src={GiftOptionsSchoolMeals} />
					...
					<div className="option">
						...
						<div className="microfinance">
							<div className="microimage">
								<img src={ButcherThankYou} />
							</div>
							<div className="microfinancetext">
								€250 = full capital requirement to finance a
								business venture. This will stimulate economic
								growth, boost household income, empower a female
								role model. You will be kept up to date on the
				...
				/>
				<div>
					Rise Rwanda, a.k.a. Rwamagana School Children’s Fund, is a
					registered Irish charity. Our charity number is CHY20665. As
					a registered Irish charity, your support is essential to us.
					We strive for the up most standard of governance,
					accountability and transparency. Transparency has a key role
					in maintaining and building trust. Our Board of Directors
					are unpaid volunteers who receive no salary for their time
					given to the charity.  All work is carried out on a
					voluntary basis.  100% of donations received go directly to
					the fund.  All and all administrative costs, travel costs
					and time are covered by the founders.
				</div>
			</div>
		);
	}
